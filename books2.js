			...
			$book.on( 'click', function() {
				...
				if( $book.data( 'opened' ) ) {
					$book.data( 'opened', false ).removeClass( 'bk-viewinside' ).on( transEndEventName, function() {
						...
						$( this ).off( transEndEventName ).removeClass( 'positionbook' );
						$parent.removeClass( 'displaybook' );
					...
					$book.data( 'opened', true ).addClass( 'bk-outside' ).on( transEndEventName, function() {
						...
						$( this ).off( transEndEventName ).addClass( 'positionbook' );
						$parent.addClass( 'displaybook' );
